...
@section('content')
    ...
    <div class="flex justify-between items-center p-2 mt-4">
        <div class="w-[10%]">
            <button id="showAdd"
                class=" text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"><svg
