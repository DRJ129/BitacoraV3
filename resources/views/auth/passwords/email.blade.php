...
<div class="min-h-screen flex items-center justify-center px-6 py-12 md:px-12">
    <div class="bg-neutral-primary-soft block md:min-w-lg p-6 border border-default rounded-base shadow-xs">
        <h5 class="mb-3 text-2xl font-semibold tracking-tight text-heading leading-8">Recuperar contraseña</h5>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="text-right">
                <button type="submit" class="text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5">Enviar enlace</button>
            </div>
        </form>
    </div>
</div>
